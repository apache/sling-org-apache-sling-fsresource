...
public class ObjectConverterTest {
    ...
    public void testDateToString() {
        ...
        Convert.fromPrimitive(BOOLEAN_1, BOOLEAN_2)
                .to(Boolean.toString(BOOLEAN_1), Boolean.toString(BOOLEAN_2))
                .test();
        Convert.from(BOOLEAN_1, BOOLEAN_2)
                .to(Boolean.toString(BOOLEAN_1), Boolean.toString(BOOLEAN_2))
                .test();
        Convert.fromPrimitive(BYTE_1, BYTE_2)
                .to(Byte.toString(BYTE_1), Byte.toString(BYTE_2))
                .test();
        Convert.from(BYTE_1, BYTE_2)
                .to(Byte.toString(BYTE_1), Byte.toString(BYTE_2))
                .test();
        Convert.fromPrimitive(SHORT_1, SHORT_2)
                .to(Short.toString(SHORT_1), Short.toString(SHORT_2))
                .test();
        Convert.from(SHORT_1, SHORT_2)
                .to(Short.toString(SHORT_1), Short.toString(SHORT_2))
                .test();
        Convert.fromPrimitive(INT_1, INT_2)
                .to(Integer.toString(INT_1), Integer.toString(INT_2))
                .test();
        Convert.from(INT_1, INT_2)
                .to(Integer.toString(INT_1), Integer.toString(INT_2))
                .test();
        Convert.fromPrimitive(LONG_1, LONG_2)
                .to(Long.toString(LONG_1), Long.toString(LONG_2))
                .test();
        Convert.from(LONG_1, LONG_2)
                .to(Long.toString(LONG_1), Long.toString(LONG_2))
                .test();
        Convert.fromPrimitive(FLOAT_1, FLOAT_2)
                .to(Float.toString(FLOAT_1), Float.toString(FLOAT_2))
                .test();
        Convert.from(FLOAT_1, FLOAT_2)
                .to(Float.toString(FLOAT_1), Float.toString(FLOAT_2))
                .test();
        Convert.fromPrimitive(DOUBLE_1, DOUBLE_2)
                .to(Double.toString(DOUBLE_1), Double.toString(DOUBLE_2))
                .test();
        Convert.from(DOUBLE_1, DOUBLE_2)
                .to(Double.toString(DOUBLE_1), Double.toString(DOUBLE_2))
                .test();
        Convert.from(BIGDECIMAL_1, BIGDECIMAL_2)
                .to(BIGDECIMAL_1.toString(), BIGDECIMAL_2.toString())
                .test();
        Convert.from(CALENDAR_1, CALENDAR_2)
                .to(calendarToString(CALENDAR_1), calendarToString(CALENDAR_2))
                .test();
        Convert.from(DATE_1, DATE_2)
                .to(calendarToString(toCalendar(DATE_1)), calendarToString(toCalendar(DATE_2)))
                .test();
    }
    ...
    public void testToBoolean() {
        ...
        Convert.from(Boolean.toString(BOOLEAN_1), Boolean.toString(BOOLEAN_2))
    ...
    public void testToByte() {
        ...
        Convert.from(Byte.toString(BYTE_1), Byte.toString(BYTE_2))
                .to(BYTE_1, BYTE_2)
                .test();
    ...
    public void testToShort() {
        ...
        Convert.from(Short.toString(SHORT_1), Short.toString(SHORT_2))
                .to(SHORT_1, SHORT_2)
                .test();
    ...
    public void testToInteger() {
        ...
        Convert.from(Integer.toString(INT_1), Integer.toString(INT_2))
                .to(INT_1, INT_2)
                .test();
    ...
    public void testToLong() {
        ...
        Convert.from(Long.toString(LONG_1), Long.toString(LONG_2))
                .to(LONG_1, LONG_2)
                .test();
    ...
    public void testToFloat() {
        ...
        Convert.from(Float.toString(FLOAT_1), Float.toString(FLOAT_2))
                .to(FLOAT_1, FLOAT_2)
                .test();
        ...
        Convert.fromPrimitive(SHORT_1, SHORT_2)
                .to((float) SHORT_1, (float) SHORT_2)
                .test();
    ...
    public void testToDouble() {
        ...
        Convert.from(Double.toString(DOUBLE_1), Double.toString(DOUBLE_2))
                .to(DOUBLE_1, DOUBLE_2)
                .test();

        // test conversion from other number types
        Convert.from(SHORT_1, SHORT_2).to((double) SHORT_1, (double) SHORT_2).test();
        Convert.fromPrimitive(SHORT_1, SHORT_2)
                .to((double) SHORT_1, (double) SHORT_2)
                .test();
    ...
    public void testToBigDecimal() {
        ...
        Convert.from(BIGDECIMAL_1.toString(), BIGDECIMAL_2.toString())
                .to(BIGDECIMAL_1, BIGDECIMAL_2)
                .test();

        // test conversion from other number types
        Convert.from(LONG_1, LONG_2)
                .to(BigDecimal.valueOf(LONG_1), BigDecimal.valueOf(LONG_2))
                .test();
        Convert.fromPrimitive(LONG_1, LONG_2)
                .to(BigDecimal.valueOf(LONG_1), BigDecimal.valueOf(LONG_2))
                .test();
        Convert.from(DOUBLE_1, DOUBLE_2)
                .to(BigDecimal.valueOf(DOUBLE_1), BigDecimal.valueOf(DOUBLE_2))
                .test();
        Convert.fromPrimitive(DOUBLE_1, DOUBLE_2)
                .to(BigDecimal.valueOf(DOUBLE_1), BigDecimal.valueOf(DOUBLE_2))
                .test();
    ...
    public void testToCalendar() {
        ...
        Convert.from(DateUtils.calendarToString(CALENDAR_1), DateUtils.calendarToString(CALENDAR_2))
                .to(CALENDAR_1, CALENDAR_2)
                .test();
        ...
        // test other types that should not be converted
        Convert.<String, Calendar>from(STRING_1, STRING_2)
                .toNull(Calendar.class)
                .test();
        Convert.<Boolean, Calendar>from(BOOLEAN_1, BOOLEAN_2)
                .toNull(Calendar.class)
                .test();
    }
    ...
    public void testToDate() {
        ...
        Convert.from(DateUtils.dateToString(DATE_1), DateUtils.dateToString(DATE_2))
                .to(DATE_1, DATE_2)
                .test();

        // test conversion from other date types
        Convert.from(CALENDAR_1, CALENDAR_2)
                .to(toDate(CALENDAR_1), toDate(CALENDAR_2))
                .test();
